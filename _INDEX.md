...
- `plans/movement_coverage_denominator.yaml` — **不是覆蓋率真相源**（該檔第 10 行自己寫明相位集合分歧時以 `_taxonomy.yaml` 的登錄表為準）。它保留的是各相位的證據引文。覆蓋率一律看 `KNOWLEDGE_MAP.md` 的「相位覆蓋」表，由登錄表 59 相位算出：**44/59**（自由式 6/12、仰式 **7/7**、蛙式 8/9、蝶式 **10/11**、udk 4/7、起跳轉身 **9/13**）
...
*最後更新：2026-09-03（(B) 組執行輪：W10／W11／W12 串行發包全部驗收落地，10 筆 demand、零新增 action／muscle；覆蓋 34/59 → **44/59**）*
